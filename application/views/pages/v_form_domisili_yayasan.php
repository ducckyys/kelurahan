    ...
    <div class="container">
        ...
        <div class="card shadow-sm brand-card">
            <div class="card-body p-4 p-md-5">
                ...
                <div class="row g-3">
                    <div class="col-md-6"><label class="form-label">Nama Penanggung Jawab</label><input type="text" name="nama_penanggung_jawab" value="<?= set_value('nama_penanggung_jawab'); ?>" class="form-control <?= form_error('nama_penanggung_jawab') ? 'is-invalid' : ''; ?>" required>
                        <div class="invalid-feedback"><?= form_error('nama_penanggung_jawab'); ?></div>
                    </div>
                    <div class="col-md-6"><label class="form-label">NIK Penanggung Jawab</label><input type="text" name="nik" value="<?= set_value('nik'); ?>" class="form-control <?= form_error('nik') ? 'is-invalid' : ''; ?>" required>
                    ...
                    <div class="col-md-6"><label class="form-label">Kewarganegaraan</label><input type="text" name="kewarganegaraan" value="<?= set_value('kewarganegaraan', 'Indonesia'); ?>" class="form-control <?= form_error('kewarganegaraan') ? 'is-invalid' : ''; ?>" required>
                ...
                <div class="row g-3">
                    <div class="col-md-6"><label class="form-label">Nama Organisasi</label><input type="text" name="nama_organisasi" value="<?= set_value('nama_organisasi'); ?>" class="form-control <?= form_error('nama_organisasi') ? 'is-invalid' : ''; ?>" required>
                        <div class="invalid-feedback"><?= form_error('nama_organisasi'); ?></div>
                    </div>
                    <div class="col-md-6"><label class="form-label">Jenis Kegiatan</label><input type="text" name="jenis_kegiatan" value="<?= set_value('jenis_kegiatan'); ?>" class="form-control <?= form_error('jenis_kegiatan') ? 'is-invalid' : ''; ?>" required>
                        <div class="invalid-feedback"><?= form_error('jenis_kegiatan'); ?></div>
                    </div>
                    <div class="col-md-6"><label class="form-label">Jumlah Pengurus</label><input type="number" name="jumlah_pengurus" value="<?= set_value('jumlah_pengurus'); ?>" class="form-control <?= form_error('jumlah_pengurus') ? 'is-invalid' : ''; ?>" required>
                        <div class="invalid-feedback"><?= form_error('jumlah_pengurus'); ?></div>
                    </div>
                    <div class="col-md-6"><label class="form-label">NPWP</label><input type="text" name="npwp" value="<?= set_value('npwp'); ?>" class="form-control <?= form_error('npwp') ? 'is-invalid' : ''; ?>" required>
                ...
                <p class="text-muted small">Isi data Akta Pendirian. Jika ada Akta Perubahan, isi juga.</p>

                <h6>Akta Pendirian</h6>
                <div class="row g-3">
                    <div class="col-md-12"><label class="form-label">Nama Notaris</label><input type="text" name="nama_notaris_pendirian" value="<?= set_value('nama_notaris_pendirian'); ?>" class="form-control <?= form_error('nama_notaris_pendirian') ? 'is-invalid' : ''; ?>" required>
                        <div class="invalid-feedback"><?= form_error('nama_notaris_pendirian'); ?></div>
                    </div>
                    <div class="col-md-6"><label class="form-label">Nomor Akta</label><input type="text" name="nomor_akta_pendirian" value="<?= set_value('nomor_akta_pendirian'); ?>" class="form-control <?= form_error('nomor_akta_pendirian') ? 'is-invalid' : ''; ?>" required>
                ...
                <div class="row g-3">
                    <div class="col-md-12"><label class="form-label">Nama Notaris</label><input type="text" name="nama_notaris_perubahan" value="<?= set_value('nama_notaris_perubahan'); ?>" class="form-control <?= form_error('nama_notaris_perubahan') ? 'is-invalid' : ''; ?>"></div>
                    <div class="col-md-6"><label class="form-label">Nomor Akta</label><input type="text" name="nomor_akta_perubahan" value="<?= set_value('nomor_akta_perubahan'); ?>" class="form-control <?= form_error('nomor_akta_perubahan') ? 'is-invalid' : ''; ?>"></div>
                    <div class="col-md-6"><label class="form-label">Tanggal Akta</label><input type="date" name="tanggal_akta_perubahan" value="<?= set_value('tanggal_akta_perubahan'); ?>" class="form-control <?= form_error('tanggal_akta_perubahan') ? 'is-invalid' : ''; ?>"></div>
                </div>

                <div class="form-check mt-4">
                    <input class="form-check-input <?= form_error('agree') ? 'is-invalid' : ''; ?>" type="checkbox" name="agree" value="1" id="agree_yys" required>
