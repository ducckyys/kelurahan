    ...
    <div class="container">
        ...
        <div class="card shadow-sm">
            <div class="card-body p-4 p-md-5">
                ...
                <form method="post" action="<?= base_url('pelayanan/submit_domisili_yayasan'); ?>" enctype="multipart/form-data">

                    <h5 class="mb-4">Data Pengantar RT/RW</h5>
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label class="form-label">Nomor Surat RT/RW</label>
                            <input type="text" name="nomor_surat_rt" value="<?= set_value('nomor_surat_rt'); ?>" placeholder="Nomor surat pengantar RT/RW" class="form-control <?= form_error('nomor_surat_rt') ? 'is-invalid' : ''; ?>" required>
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="nama_penanggung_jawab" value="<?= set_value('nama_penanggung_jawab'); ?>" placeholder="Nama penanggung jawab" class="form-control <?= form_error('nama_penanggung_jawab') ? 'is-invalid' : ''; ?>" required>
                            <div class="invalid-feedback"><?= form_error('nama_penanggung_jawab'); ?></div>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">NIK Penanggung Jawab</label>
                            <input type="text" name="nik" value="<?= set_value('nik'); ?>" placeholder="16 digit NIK" class="form-control <?= form_error('nik') ? 'is-invalid' : ''; ?>" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="tempat_lahir" value="<?= set_value('tempat_lahir'); ?>" placeholder="Contoh: Tangerang Selatan" class="form-control <?= form_error('tempat_lahir') ? 'is-invalid' : ''; ?>" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="kewarganegaraan" value="<?= set_value('kewarganegaraan', 'Indonesia'); ?>" placeholder="Contoh: Indonesia" class="form-control <?= form_error('kewarganegaraan') ? 'is-invalid' : ''; ?>" required>
                            <div class="invalid-feedback"><?= form_error('kewarganegaraan'); ?></div>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Agama</label>
                            <input type="text" name="agama" value="<?= set_value('agama'); ?>" placeholder="Contoh: Islam" class="form-control <?= form_error('agama') ? 'is-invalid' : ''; ?>" required>
                            <div class="invalid-feedback"><?= form_error('agama'); ?></div>
                        </div>
                        <div class="col-12">
                            <label class="form-label">Alamat Sesuai KTP</label>
                            <textarea name="alamat_pemohon" rows="3" placeholder="Contoh: Jl. Melati No. 10, RT 001/RW 002, Kademangan" class="form-control <?= form_error('alamat_pemohon') ? 'is-invalid' : ''; ?>" required><?= set_value('alamat_pemohon'); ?></textarea>
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="nama_organisasi" value="<?= set_value('nama_organisasi'); ?>" placeholder="Contoh: Yayasan Citra Bangsa" class="form-control <?= form_error('nama_organisasi') ? 'is-invalid' : ''; ?>" required>
                            <div class="invalid-feedback"><?= form_error('nama_organisasi'); ?></div>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Jenis Kegiatan</label>
                            <input type="text" name="jenis_kegiatan" value="<?= set_value('jenis_kegiatan'); ?>" class="form-control <?= form_error('jenis_kegiatan') ? 'is-invalid' : ''; ?>" placeholder="Contoh: Sosial / Pendidikan / Keagamaan" required>
                            <div class="invalid-feedback"><?= form_error('jenis_kegiatan'); ?></div>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Jumlah Pengurus</label>
                            <input type="number" name="jumlah_pengurus" value="<?= set_value('jumlah_pengurus'); ?>" class="form-control <?= form_error('jumlah_pengurus') ? 'is-invalid' : ''; ?>" placeholder="Contoh: 12" required>
                            <div class="invalid-feedback"><?= form_error('jumlah_pengurus'); ?></div>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">NPWP</label>
                            <input type="text" name="npwp" value="<?= set_value('npwp'); ?>" class="form-control <?= form_error('npwp') ? 'is-invalid' : ''; ?>" placeholder="Contoh: 12.345.678.9-012.345" required>
                            <div class="invalid-feedback"><?= form_error('npwp'); ?></div>
                        </div>
                        <div class="col-12">
                            <label class="form-label">Alamat Kantor</label>
                            <textarea name="alamat_kantor" rows="3" class="form-control <?= form_error('alamat_kantor') ? 'is-invalid' : ''; ?>" placeholder="Contoh: Jl. Kenanga No. 3, RT 003/RW 005, Kademangan" required><?= set_value('alamat_kantor'); ?></textarea>
                    ...
                    <div class="row g-3">
                        <div class="col-md-12">
                            ...
                            <input type="text" name="nama_notaris_pendirian" value="<?= set_value('nama_notaris_pendirian'); ?>" class="form-control <?= form_error('nama_notaris_pendirian') ? 'is-invalid' : ''; ?>" placeholder="Contoh: Not. Budi Santoso, S.H., M.Kn." required>
                            <div class="invalid-feedback"><?= form_error('nama_notaris_pendirian'); ?></div>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Nomor Akta</label>
                            <input type="text" name="nomor_akta_pendirian" value="<?= set_value('nomor_akta_pendirian'); ?>" class="form-control <?= form_error('nomor_akta_pendirian') ? 'is-invalid' : ''; ?>" placeholder="Contoh: 12/AKTA/YYSN/I/2025" required>
                            <div class="invalid-feedback"><?= form_error('nomor_akta_pendirian'); ?></div>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Tanggal Akta</label>
                            <input type="date" name="tanggal_akta_pendirian" value="<?= set_value('tanggal_akta_pendirian'); ?>" class="form-control <?= form_error('tanggal_akta_pendirian') ? 'is-invalid' : ''; ?>" required>
                    ...
                    <div class="row g-3">
                        <div class="col-md-12">
                            <label class="form-label">Nama Notaris</label>
                            <input type="text" name="nama_notaris_perubahan" value="<?= set_value('nama_notaris_perubahan'); ?>" class="form-control <?= form_error('nama_notaris_perubahan') ? 'is-invalid' : ''; ?>" placeholder="Contoh: Not. Siti Rahmawati, S.H., M.Kn.">
                            <div class="invalid-feedback"><?= form_error('nama_notaris_perubahan'); ?></div>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Nomor Akta</label>
                            <input type="text" name="nomor_akta_perubahan" value="<?= set_value('nomor_akta_perubahan'); ?>" class="form-control <?= form_error('nomor_akta_perubahan') ? 'is-invalid' : ''; ?>" placeholder="Contoh: 05/AKTA-PERUBAHAN/III/2025">
                            <div class="invalid-feedback"><?= form_error('nomor_akta_perubahan'); ?></div>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Tanggal Akta</label>
                            <input type="date" name="tanggal_akta_perubahan" value="<?= set_value('tanggal_akta_perubahan'); ?>" class="form-control <?= form_error('tanggal_akta_perubahan') ? 'is-invalid' : ''; ?>">
                            <div class="invalid-feedback"><?= form_error('tanggal_akta_perubahan'); ?></div>
                        </div>
                    </div>

                    <div class="form-check mt-4">
                        <input class="form-check-input <?= form_error('agree') ? 'is-invalid' : ''; ?>" type="checkbox" name="agree" value="1" id="agree_sktm" required>
