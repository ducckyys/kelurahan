 ...
 * - Atribut HTML seperti required, autocomplete, dan inputmode membantu UX,
 *   sedangkan validasi akhir tetap melalui CI Form Validation di server.
 * ============================================================================
 */
?>
<section class="py-5">
    <div class="container">
        <?php
        $title    = $title    ?? 'Surat Keterangan Belum Bekerja';
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" name="keperluan"
                            ...
                            placeholder="Tuliskan keperluan singkat, misal: Persyaratan administrasi sekolah"
                            autocomplete="off"
