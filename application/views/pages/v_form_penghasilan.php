<?php
// View: Formulir Surat Keterangan Penghasilan (tanpa nominal/sumber/tanggungan)
?>
<section class="py-5">
    <div class="container">
        <?php
        $title    = $title    ?? 'Surat Keterangan Penghasilan';
        ...
        <div class="card shadow-sm brand-card">
            <div class="card-body p-4 p-md-5">
                <?= form_open_multipart('pelayanan/submit_penghasilan'); ?>
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="nomor_surat_rt"
                            ...
                            placeholder="Contoh: 012/RT01/RW02/2025" autocomplete="off"
                    ...
                    <div class="col-12">
                        ...
                        <?php else: ?>
                            <div class="form-text">Unggah minimal 1 dokumen (KTP, KK, & pengantar RT/RW). Maks 2&nbsp;MB per file.</div>
                        <?php endif; ?>
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="nama_pemohon" value="<?= set_value('nama_pemohon'); ?>"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="nik" value="<?= set_value('nik'); ?>"
                            placeholder="16 digit NIK" inputmode="numeric" autocomplete="off"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="telepon_pemohon" value="<?= set_value('telepon_pemohon'); ?>"
                            placeholder="08xxxxxxxxxx" inputmode="tel" autocomplete="tel"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="tempat_lahir" value="<?= set_value('tempat_lahir'); ?>"
                            placeholder="Kota/Kabupaten" autocomplete="address-level2"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="warganegara" value="<?= set_value('warganegara'); ?>"
                            placeholder="Misal: Indonesia" autocomplete="country-name"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="agama" value="<?= set_value('agama'); ?>"
                            placeholder="Misal: Islam" autocomplete="off"
                ...
                <div class="form-check mt-4">
                    <input class="form-check-input <?= form_error('agree') ? 'is-invalid' : ''; ?>"
                        type="checkbox" name="agree" value="1" id="agree_penghasilan" required>
                    <label class="form-check-label" for="agree_penghasilan">Saya menyatakan data yang saya isi adalah benar.</label>
