<div class="page-inner">
    <div class="page-header">
        <h4 class="page-title">Data Surat Keterangan Domisili Yayasan</h4>
        <ul class="breadcrumbs">
            ...
            <li class="separator"><i class="flaticon-right-arrow"></i></li>
            <li class="nav-item"><a>Data Surat Keterangan Domisili Yayasan</a></li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-12">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-button-action">
                                                <!-- Lihat -->
                                                <a href="<?= base_url('admin/surat_domisili_yayasan/detail/' . $item->id); ?>"
                                                ...
                                                <!-- Ubah -->
                                                <a href="<?= base_url('admin/surat_domisili_yayasan/edit/' . $item->id); ?>"
                                                ...
                                                <!-- Hapus -->
                                                <a href="<?= base_url('admin/surat_domisili_yayasan/delete/' . $item->id); ?>"
