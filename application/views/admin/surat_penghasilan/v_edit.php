...
<div class="page-inner">
    <div class="page-header">
        <h4 class="page-title">Edit Ket. Penghasilan</h4>
        <ul class="breadcrumbs">
            <li class="nav-home"><a href="<?= base_url('admin/dashboard') ?>"><i class="flaticon-home"></i></a></li>
            <li class="separator"><i class="flaticon-right-arrow"></i></li>
            <li class="nav-item"><a href="<?= base_url('admin/surat_penghasilan') ?>">Data Ket. Penghasilan</a></li>
            <li class="separator"><i class="flaticon-right-arrow"></i></li>
    ...
    <?php if (!$can_full): ?>
        <div class="alert alert-info">
            Anda login sebagai <b>admin</b>. Anda hanya dapat mengubah <b>Status</b> dan <b>Nomor Surat</b>. Field lainnya terkunci.
        </div>
    <?php endif; ?>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        <a href="<?= base_url('admin/surat_penghasilan/detail/' . $surat->id); ?>" class="btn btn-secondary btn-round ml-auto">Batal</a>
                    </div>
                </div>

                <form action="<?= base_url('admin/surat_penghasilan/update/' . $surat->id); ?>" method="POST" enctype="multipart/form-data">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group"><label>Status Pengajuan</label>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group"><label>Nama Lengkap</label>
                                    <input type="text" name="nama_pemohon" class="form-control" value="<?= html_escape($surat->nama_pemohon); ?>" <?= $ro ?> required>
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group"><label>Warganegara</label>
                                    <input type="text" name="warganegara" class="form-control" value="<?= html_escape($surat->warganegara); ?>" <?= $ro ?> required>
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group"><label>Pekerjaan</label>
                                    <input type="text" name="pekerjaan" class="form-control" value="<?= html_escape($surat->pekerjaan); ?>" <?= $ro ?> required>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group"><label>Alamat Lengkap</label>
                                    <textarea name="alamat" class="form-control" rows="3" <?= $ro ?> required><?= html_escape($surat->alamat); ?></textarea>
                                </div>
                            </div>
                            <div class="col-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <small class="form-text text-muted">File baru akan <b>ditambahkan</b> ke daftar lampiran.</small>
                                </div>
                                <?php if (!empty($files)): ?>
                                    <div class="mt-2"><label class="d-block">Lampiran Saat Ini:</label>
                                        <ul class="mb-0">
                                            <?php foreach ($files as $fn): ?><li><a href="<?= base_url('uploads/pendukung/' . $fn); ?>" target="_blank" rel="noopener"><?= html_escape($fn) ?></a></li><?php endforeach; ?>
                                        </ul>
                                    </div>
                                <?php else: ?><small class="text-muted">Belum ada dokumen terunggah.</small><?php endif; ?>
                            </div>
                        </div>
                    </div>
                    <div class="card-action"><button type="submit" class="btn btn-success"><i class="fa fa-save"></i> Simpan Perubahan</button></div>
                </form>
            </div>
        </div>
    </div>
