...
<div class="page-inner">
    <div class="page-header">
        ...
        <ul class="breadcrumbs">
            ...
            <li class="separator"><i class="flaticon-right-arrow"></i></li>
            <li class="nav-item"><a>Data Pengantar Nikah</a></li>
        </ul>
    </div>
                        ...
                        <table id="basic-datatables" class="display table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                foreach ($list as $item): ?>
                                    <tr>
                                        <td><?= $no++; ?></td>
                                        <td><?= html_escape($item->pria_nama); ?></td>
                                        <td><?= html_escape($item->wanita_nama); ?></td>
                                        ...
                                        <td>
                                            <div class="form-button-action">
                                                <!-- Lihat -->
                                                <a href="<?= base_url('admin/surat_pengantar_nikah/detail/' . $item->id); ?>"
                                                ...
                                                <!-- Ubah -->
                                                <a href="<?= base_url('admin/surat_pengantar_nikah/edit/' . $item->id); ?>"
                                                ...
                                                <!-- Hapus -->
                                                <a href="<?= base_url('admin/surat_pengantar_nikah/delete/' . $item->id); ?>"
