...
<head>
    ...
    <style>
        ...
        :root {
            ...
            --ttd-width: 100mm;
            /* besarkan jika perlu agar nama panjang tidak turun */
        }
...
<body>
    ...
    <div id="content">
        ...
        <p class="isi-surat pembuka">
            Nama tersebut di atas adalah benar bertempat tinggal di Kelurahan Kademangan dan berdasarkan Surat Pengantar RT/RW
            Nomor <b><?= html_escape($surat->nomor_surat_rt); ?></b>
            tanggal <b><?= date('d F Y', strtotime($surat->tanggal_surat_rt)); ?></b>,
            yang bersangkutan dinyatakan <b>BELUM MEMILIKI RUMAH</b>.
        </p>
        <p class="isi-surat pembuka">
