<div class="page-inner">
    <div class="page-header">
        <h4 class="page-title">Data Surat Keterangan Kematian (Dukcapil)</h4>
        <ul class="breadcrumbs">
            ...
            <li class="separator"><i class="flaticon-right-arrow"></i></li>
            <li class="nav-item"><a>Data Surat Keterangan Kematian (Dukcapil)</a></li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-12">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-button-action">
                                                <!-- Detail -->
                                                <a href="<?= base_url('admin/surat_kematian/detail/' . $item->id); ?>"
                                                    class="btn btn-link btn-info" title="Detail">
                                                ...
                                                <!-- Ubah -->
                                                <a href="<?= base_url('admin/surat_kematian/edit/' . $item->id); ?>"
                                                ...
                                                <!-- Hapus -->
                                                <a href="<?= base_url('admin/surat_kematian/delete/' . $item->id); ?>"
