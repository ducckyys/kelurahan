        ...
        <div class="col-md-12">
            <div class="card">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <dl class="row">
                                ...
                                <dt class="col-sm-4">Sebab Meninggal</dt>
                                <dd class="col-sm-8">: <?= html_escape($surat->sebab_meninggal); ?></dd>
                                <dt class="col-sm-4">Tempat Pemakaman</dt>
                        ...
                        <div class="col-md-6">
                            ...
                            <dl class="row">
                                ...
                                <dt class="col-sm-4">Alamat</dt>
                                <dd class="col-sm-8">: <?= html_escape($surat->pelapor_alamat); ?></dd>
                                <dt class="col-sm-4">Hubungan</dt>
                                <dd class="col-sm-8">: <?= html_escape($surat->pelapor_hubungan); ?></dd>
                            </dl>
                            <?php if (!empty($surat->nomor_surat_rt)): ?>
                                <hr>
                ...
                <div class="card-footer">
                    ...
                    <?php if ($bisaCetak): ?>
                        <a href="<?= base_url('admin/surat_kematian/cetak/' . $surat->id); ?>" target="_blank" class="btn btn-success">
