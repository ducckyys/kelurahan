<div class="page-inner">
    <div class="page-header">
        <h4 class="page-title">Detail Kematian Non Dukcapil</h4>
            ...
            <div class="card">
                ...
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        <a href="<?= base_url('admin/surat_kematian_nondukcapil'); ?>" class="btn btn-secondary btn-round ml-auto">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <dl class="row">
                                ...
                                <dd class="col-sm-8">: <?= html_escape($surat->nik_ahli_waris); ?></dd>
                            ...
                            <dl class="row">
                                <dt class="col-sm-4">Nama</dt>
                                <dd class="col-sm-8">: <?= html_escape($surat->nama_almarhum); ?></dd>
                                <dt class="col-sm-4">NIK</dt>
                    ...
                    <?php if (!empty($bisaCetak) && $bisaCetak): ?>
                        <?php if (!empty($signers)): ?>
                            <form class="form-inline d-inline-flex align-items-center ml-2"
                                action="<?= base_url('admin/surat_kematian_nondukcapil/cetak/' . $surat->id); ?>"
                        ...
                        <?php else: ?>
                            <button class="btn btn-success ml-2" disabled title="Data penandatangan belum diisi di Pengaturan → Pejabat">
                                <i class="fa fa-print"></i> Cetak Surat (PDF)
                            </button>
                        <?php endif; ?>
                    <?php else: ?>
