<div class="page-inner">
    <div class="page-header">
        ...
        <ul class="breadcrumbs">
            ...
            <li class="separator"><i class="flaticon-right-arrow"></i></li>
            <li class="nav-item"><a>Data Surat Keterangan Tidak Mampu</a></li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-12">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-button-action">
                                                <!-- Lihat -->
                                                <a href="<?= base_url('admin/surat_sktm/detail/' . $item->id); ?>"
                                                ...
                                                <!-- Ubah -->
                                                <a href="<?= base_url('admin/surat_sktm/edit/' . $item->id); ?>"
                                                ...
                                                <!-- Hapus -->
                                                <a href="<?= base_url('admin/surat_sktm/delete/' . $item->id); ?>"
