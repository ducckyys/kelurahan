    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <form action="<?= base_url('admin/surat_nikah/update/' . $surat->id); ?>" method="POST">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group"><label>Nama Pasangan</label><input type="text" name="nama_pasangan" class="form-control" value="<?= html_escape($surat->nama_pasangan); ?>" required></div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group"><label>Tanggal Nikah</label><input type="date" name="tanggal_nikah" class="form-control" value="<?= $surat->tanggal_nikah; ?>" required></div>
                            </div>
                        </div>
                    </div>
                    <div class="card-action">
                        <button type="submit" class="btn btn-primary">Simpan Perubahan</button>
                        <a href="<?= base_url('admin/surat_nikah'); ?>" class="btn btn-danger">Batal</a>
                    </div>
                </form>
            </div>
        </div>
