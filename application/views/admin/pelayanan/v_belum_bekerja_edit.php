            ...
            <div class="card">
                ...
                <form action="<?= base_url('admin/surat_belum_bekerja/update/' . $surat->id); ?>" method="POST">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group"><label>Nomor Surat RT/RW</label><input type="text" name="nomor_surat_rt" class="form-control" value="<?= html_escape($surat->nomor_surat_rt); ?>" required></div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group"><label>Tanggal Surat RT/RW</label><input type="date" name="tanggal_surat_rt" class="form-control" value="<?= $surat->tanggal_surat_rt; ?>" required></div>
                            </div>
                            <div class="col-12">
                                <div class="form-group"><label>Scan Surat RT/RW</label><br><a href="<?= base_url('uploads/surat_rt/' . $surat->scan_surat_rt); ?>" target="_blank" class="btn btn-info btn-sm">Lihat File</a></div>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-group"><label>Alamat Lengkap</label><textarea name="alamat" class="form-control" required><?= html_escape($surat->alamat); ?></textarea></div>
                            </div>
                            <div class="col-12">
                                <div class="form-group"><label>Diperlukan Untuk</label><input type="text" name="keperluan" class="form-control" value="<?= html_escape($surat->keperluan); ?>" required></div>
                            </div>
                        </div>
                    </div>
