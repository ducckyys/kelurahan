                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-button-action">
                                                <!-- Lihat -->
                                                <a href="<?= base_url('admin/surat_belum_bekerja/detail/' . $item->id); ?>"
                                                ...
                                                <!-- Ubah -->
                                                <a href="<?= base_url('admin/surat_belum_bekerja/edit/' . $item->id); ?>"
                                                ...
                                                <!-- Hapus -->
                                                <a href="<?= base_url('admin/surat_belum_bekerja/delete/' . $item->id); ?>"
