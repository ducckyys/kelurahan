<div class="page-inner">
    <div class="page-header">
        <h4 class="page-title">Data Ket. Belum Bekerja</h4>
        <ul class="breadcrumbs">
            ...
            <li class="separator"><i class="flaticon-right-arrow"></i></li>
            <li class="nav-item"><a>Data Ket. Belum Bekerja</a></li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-12">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-button-action">
                                                <a href="<?= base_url('admin/surat_belum_bekerja/detail/' . $item->id); ?>" title="Lihat Detail" class="btn btn-link btn-info"><i class="fa fa-eye"></i></a>
