...
class M_kematian extends CI_Model
{
    ...
    /** Alias supaya kompatibel dengan controller submit_* */
    ...
    // =====================================
    //  Helper kolom dokumen_pendukung (JSON)
    // =====================================
    ...
    /** Set penuh (replace) dokumen_pendukung */
